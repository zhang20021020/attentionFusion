...
FOLDER = os.environ.get("ISPRS_FOLDER", "/home/zhangben/ISPRS_dataset/").rstrip("/\\") + os.sep
BATCH_SIZE = 5
...
# MODEL = 'FTUNetformer'
MODE = 'VIS'
DATASET = os.environ.get("VIS_DATASET", "Potsdam")
IF_SAM = True
# IF_SAM = False
...
if DATASET == 'Vaihingen':
    ...
    VIS_WEIGHT_PATH = os.environ.get("VIS_WEIGHT_PATH", "")
    ...
    VIS_WEIGHT_PATH = os.environ.get("VIS_WEIGHT_PATH", "/home/zhangben/mamba/attentionFusion/resultsp/UNetformer_epoch26_0.8528.pth")
else:
    raise ValueError("VIS_DATASET must be either 'Vaihingen' or 'Potsdam'.")

VIS_OUT_ROOT = os.environ.get("VIS_OUT_ROOT", "./vis_256_mamba_opt002")
VIS_PATCH_SIZE = int(os.environ.get("VIS_PATCH_SIZE", "256"))
VIS_CAM_SCALE = os.environ.get("VIS_CAM_SCALE", "mid").lower()
VIS_MAX_PATCHES = int(os.environ.get("VIS_MAX_PATCHES", "0"))
VIS_IDS = [
    item.strip()
    for item in os.environ.get("VIS_IDS", "").split(",")
    if item.strip()
]
